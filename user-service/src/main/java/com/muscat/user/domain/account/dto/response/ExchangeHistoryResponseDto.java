...
public record ExchangeHistoryResponseDto(
  ...
  public static ExchangeHistoryResponseDto from(
    com.muscat.user.domain.account.entity.AccountHistory accountHistory) {
