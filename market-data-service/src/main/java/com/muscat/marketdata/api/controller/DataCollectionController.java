...
import com.muscat.marketdata.datasource.alphavantage.service.CandleBatchService;
import com.muscat.marketdata.datasource.alphavantage.service.AlphaVantageCandleUpdateService;
 ...
 * 시가총액 업데이트는 Scheduler가 자동으로 처리합니다.
 */
@Slf4j
@RestController
...
public class DataCollectionController {
  ...
  @Value("${marketdata.batch.default-lookback-days.all:365}")
  private int defaultLookbackDaysAll;

  @Value("${marketdata.batch.default-lookback-days.single:90}")
  private int defaultLookbackDaysSingle;

  private final CandleBatchService batchService;
  private final AlphaVantageCandleUpdateService candleUpdateService;
  ...
  public ResponseEntity<Map<String, Object>> collectAllSymbols(
    ...
    try {
      ...
      LocalDate startDate = from != null ? from : endDate.minusDays(defaultLookbackDaysAll);
  ...
  public ResponseEntity<Map<String, Object>> collectSingleSymbol(
    ...
    try {
      ...
      LocalDate endDate = to != null ? to : LocalDate.now(MARKET_TIMEZONE);
      LocalDate startDate = from != null ? from : endDate.minusDays(defaultLookbackDaysSingle);
    ...
    try {
      ...
      Map<String, Object> responseData = Map.of(
        ...
        "defaultLookbackDays", Map.of(
          "allAssets", defaultLookbackDaysAll,
          "singleSymbol", defaultLookbackDaysSingle
        )
      );
