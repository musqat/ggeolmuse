...
class DividendServiceImplTest {
    ...
    class GetDividendHistoryTests {
        ...
        void getDividendHistory_WithDateRange_Success() {
            ...
            // when
            List<DividendDto> results = dividendService.getDividendHistory(TEST_SYMBOL, startDate, endDate);
            ...
            // DTO 변환 검증
            DividendDto firstDividend = results.get(0);
        ...
        void getDividendHistory_ConvertsToUpperCase_Success() {
            ...
            // when
            List<DividendDto> results = dividendService.getDividendHistory(lowerCaseSymbol, startDate, endDate);
