...
public class HoldingsServiceImpl implements HoldingsService {
  ...
  public List<HoldingResponseDto> getPortfolio(String userId, Long accountId) {
    ...
    tradeLogger.logPortfolioAccess(userId, logType, accountId != null ? accountId.toString() : null,
      holdings.size());
  ...
  public PortfolioSummary getPortfolioSummary(String userId,
    ...
    var summaryProjection = holdingsRepository.calculatePortfolioSummary(userId);
  ...
  public List<HoldingResponseDto> getHoldingsWithTradeHistory(String userId, String symbol,
    ...
    List<Holdings> holdings = holdingsRepository.findHoldingsWithTradeHistory(userId, symbol,
      minQuantity);
  ...
  public List<HoldingResponseDto> getTopPerformingHoldings(String userId, int limit) {
    ...
    List<Holdings> holdings = holdingsRepository.findTopHoldingsByInvestment(userId, limit);
  ...
  public List<HoldingResponseDto> getHoldingsByMinInvestment(String userId, BigDecimal minAmount) {
    ...
    List<Holdings> holdings = holdingsRepository.findHoldingsByMinInvestment(userId,
      minAmount);
