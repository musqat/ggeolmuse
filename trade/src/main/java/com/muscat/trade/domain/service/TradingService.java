...
public interface TradingService {
  ...
  // 주식 매수 (가격 유형별)
  TradeResponseDto buyStock(String userId, String accountId, String symbol, 
                BigDecimal quantity, LocalDate tradeDate, PriceType priceType, BigDecimal manualPrice);

  // 주식 매도 (가격 유형별)
  TradeResponseDto sellStock(String userId, String accountId, String symbol, 
                 BigDecimal quantity, LocalDate tradeDate, PriceType priceType, BigDecimal manualPrice);
  ...
  boolean canBuyStock(String userId, String accountId, BigDecimal totalAmount);
  
  boolean canSellStock(String userId, String accountId, String symbol, BigDecimal quantity);
}