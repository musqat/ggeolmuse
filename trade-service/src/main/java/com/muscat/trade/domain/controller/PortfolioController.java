...
public class PortfolioController {
  ...
  public ResponseEntity<List<HoldingResponseDto>> getAccountPortfolio(
    ...
    String userId = jwt.getSubject();
    List<HoldingResponseDto> holdings = holdingsService.getPortfolio(userId, Long.valueOf(accountId));
    return ResponseEntity.ok(holdings);
  }
  ...
  public ResponseEntity<HoldingResponseDto> getHoldingBySymbol(
    ...
    HoldingResponseDto holding = holdingsService.getHoldingBySymbol(userId, Long.valueOf(accountId), symbol);
