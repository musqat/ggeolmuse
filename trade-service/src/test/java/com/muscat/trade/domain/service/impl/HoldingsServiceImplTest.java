...
class HoldingsServiceImplTest {
    ...
    class GetPortfolioTests {
        ...
        void getPortfolio_WithAccountId_Success() {
            ...
            HoldingResponseDto dto = result.get(0);
            assertThat(dto.getSymbol()).isEqualTo(TEST_SYMBOL);
            assertThat(dto.getTotalQuantity()).isEqualByComparingTo(TEST_QUANTITY);
            assertThat(dto.getAvgPurchasePrice()).isEqualByComparingTo(TEST_AVG_PRICE);
            assertThat(dto.getCurrentPrice()).isEqualByComparingTo(TEST_CURRENT_PRICE);
    ...
    class GetPortfolioSummaryTests {
        ...
        void getPortfolioSummary_Success() {
            ...
            // 평가손익 = 1600 - 1500 = 100
            BigDecimal expectedPnL = expectedCurrentValue.subtract(TEST_QUANTITY.multiply(TEST_AVG_PRICE));
    ...
    class GetTopPerformingHoldingsTests {
        ...
        void getTopPerformingHoldings_Success() {
            ...
            assertThat(result.get(1).getSymbol()).isEqualTo("GOOGL");
            verify(tradeLogger).logPortfolioAccess(eq(TEST_USER_ID),
    ...
    class GetHoldingsByMinInvestmentTests {
        ...
        void getHoldingsByMinInvestment_Success() {
            ...
            // then
            assertThat(result).hasSize(1);
            assertThat(result.get(0).getTotalInvestedAmount())
