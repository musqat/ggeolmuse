...
public class ResponseMapper {
  ...
  public SimulationResponse toSimulationResponse(
    ...
    return SimulationResponse.builder()
        ...
        .performanceSummary(createSimulationPerformanceSummary(stockReturn, totalReturnPercent, fxReturnPercent))
        .build();
  }
  ...
  private String createPerformanceSummary(StrategyCalculationResult calculation) {
    return String.format("총 수익: $%.2f (%.2f%%), 환차익: %.2f%%",
        calculation.getTotalReturnUsd(), calculation.getTotalReturnPercent(), calculation.getFxReturnPercent());
  }

  private String createSimulationPerformanceSummary(BigDecimal totalReturn, BigDecimal totalReturnPercent, BigDecimal fxReturnPercent) {
    return String.format("총 수익: $%.2f (%.2f%%), 환차익: %.2f%%",
