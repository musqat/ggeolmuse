...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponseDto> handleUserException(UserException e, HttpServletRequest request) {
  ...
  public ResponseEntity<ErrorResponseDto> handleSocialLoginException(SocialLoginException e, HttpServletRequest request) {
  ...
  public ResponseEntity<ErrorResponseDto> handleKeycloakException(KeycloakException e, HttpServletRequest request) {
    log.error("[KEYCLOAK ERROR] {}", e.getMessage(), e);

    ErrorResponseDto errorResponse = ErrorResponseDto.of(
        request.getRequestURI(),
        e.getErrorCode().getHttpStatus(),
        "인증 서비스에 문제가 발생했습니다. 잠시 후 다시 시도해주세요.",
        ErrorType.SYSTEM
    );
  ...
  public ResponseEntity<ErrorResponseDto> handleMissingParameterException(MissingServletRequestParameterException e, HttpServletRequest request) {
