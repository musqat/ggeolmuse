  ...
  return (
    <div className={`grid grid-cols-1 ${showRemainingCash ? 'md:grid-cols-4' : 'md:grid-cols-3'} gap-4`}>
      ...
      {showRemainingCash && remainingCashKrw !== undefined && (
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-600">잔여 현금</span>
      ...
      {/* 총 수익 */}
      <div className={`bg-white border ${isProfit ? 'border-green-200' : 'border-red-200'} rounded-lg p-4`}>
        <div className="flex items-center justify-between mb-2">
